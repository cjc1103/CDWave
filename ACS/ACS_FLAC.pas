...
//    FillChar(FLACIn.Buff[0], FLACIn.BytesPerBlock, 255);
  ...
  begin
    ...
    begin
      ...
      else FStream := TFileStream.Create(FFileName, fmOpenReadWrite or fmShareExclusive);
    end;
    EndOfInput := False;
  ...
  begin
    ...
    begin
      ...
      if not FStreamAssigned then FStream := TFileStream.Create(FFileName, fmOpenRead);
      FValid := True;
